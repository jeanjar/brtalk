$(document).ready(function(){
    ...
    $('#demonstracao-atendimento').click(function(){
        ...
        window.open('https://lab.andrewd.com.br/brtalk/cliente/', 'at',  'height=' +height+ ', width=' +width+ ',status=no, toolbar=no, resizable=0, scrollbars=no, minimizable=no, left=' +left+ ', top=' +top);
